...
public class FourFib extends Transactor  {
		...
		public void act(String args[]) {
			...
			try {
				...
				Token a1 = new Token("a1");
				{
					...
					{
						Object _arguments[] = {  };
						TransactorMessage message = new TransactorMessage( self, fib1, this.wv, "compute", _arguments, null, a1 );
						__messages.add( message );
					}
				}
				Token a2 = new Token("a2");
				{
					...
					{
						Object _arguments[] = {  };
						TransactorMessage message = new TransactorMessage( self, fib2, this.wv, "compute", _arguments, null, a2 );
						__messages.add( message );
					}
				}
				Token a3 = new Token("a3");
				{
					...
					{
						Object _arguments[] = {  };
						TransactorMessage message = new TransactorMessage( self, fib3, this.wv, "compute", _arguments, null, a3 );
						__messages.add( message );
					}
				}
				Token a4 = new Token("a4");
				{
					...
					{
						Object _arguments[] = {  };
						TransactorMessage message = new TransactorMessage( self, fib4, this.wv, "compute", _arguments, null, a4 );
						__messages.add( message );
					}
				}
				{
					...
					// addAll(a1, a2, a3, a4)
					{
						...
						TransactorMessage message = new TransactorMessage( self, self, this.wv, "addAll", _arguments, null, token_3_0 );
						__messages.add( message );
					}
					// ((FourFib)self)<-end(token)
					{
						Object _arguments[] = { token_3_0 };
						TransactorMessage message = new TransactorMessage( self, ((FourFib)self), this.wv, "end", _arguments, token_3_0, null );
						__messages.add( message );
					}
				}
			}
