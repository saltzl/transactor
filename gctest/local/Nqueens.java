			...
			if (TOTALACTOR==0) {{
				{
					// ((Nqueens)self)<-show(new Integer(COUNT))
					{
						...
						TransactorMessage message = new TransactorMessage( self, ((Nqueens)self), this.wv, "show", _arguments, null, null );
				...
				if (SIZE<6) {{
					{
						...
						// ((Nqueens)self)<-show(token)
						{
							...
							TransactorMessage message = new TransactorMessage( self, ((Nqueens)self), this.wv, "show", _arguments, token_4_1, null );
							__messages.add( message );
						}
					}
				}
