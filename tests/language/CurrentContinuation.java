...
public class CurrentContinuation extends Transactor  {
		...
		public void act(String args[]) {
			{
				...
				// standardOutput<-println(token)
				{
					...
					TransactorMessage message = new TransactorMessage( self, standardOutput, this.wv, "println", _arguments, token_2_0, null );
					__messages.add( message );
				}
			}
			{
